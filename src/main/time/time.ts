...
export function KSPTime(date: number | ElapsedYDHMS, config: BaseTimeSettings | RealTimeSettings): IKSPTime {
    switch(config.type) {
    case "base":
...
export function stringYDHMS(time: IKSPTime, precision: "h" | "hm" | "hms", display: "emt" | "ut"){
